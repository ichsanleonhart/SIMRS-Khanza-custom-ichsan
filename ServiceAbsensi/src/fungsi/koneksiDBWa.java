    ...
    public static Connection condb(){ 
        if(connection == null){
            try{
                ...
                dataSource.setURL("jdbc:mysql://"+EnkripsiAES.decrypt(prop.getProperty("HOSTWA1"))+":"+EnkripsiAES.decrypt(prop.getProperty("PORTWA1"))+"/"+EnkripsiAES.decrypt(prop.getProperty("DATABASEWA1"))+"?zeroDateTimeBehavior=convertToNull&amp;autoReconnect=true");
