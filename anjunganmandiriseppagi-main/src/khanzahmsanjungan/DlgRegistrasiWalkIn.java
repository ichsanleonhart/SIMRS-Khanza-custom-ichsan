...
public class DlgRegistrasiWalkIn extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-07-2024" }));
        ...
        btnBayar.setForeground(new java.awt.Color(0, 131, 62));
        btnBayar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/pilih.png"))); // NOI18N
        btnBayar.setMnemonic('S');
        btnBayar.setToolTipText("Alt+S");
        btnBayar.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        btnBayar.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        btnBayar.setPreferredSize(new java.awt.Dimension(300, 45));
        ...
        btnBayar.setBounds(810, 220, 70, 40);

        NmBayar.setEditable(false);
        NmBayar.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        NmBayar.setPreferredSize(new java.awt.Dimension(72, 28));
        ...
        jPanel2.add(NmBayar);
        NmBayar.setBounds(390, 220, 420, 40);

        KdBayar.setEditable(false);
        KdBayar.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        KdBayar.setPreferredSize(new java.awt.Dimension(72, 28));
        ...
        jPanel2.add(KdBayar);
        KdBayar.setBounds(290, 220, 100, 40);
...
//        poli.setVisible(true);
    ...
    private component.Button btnBayar;
