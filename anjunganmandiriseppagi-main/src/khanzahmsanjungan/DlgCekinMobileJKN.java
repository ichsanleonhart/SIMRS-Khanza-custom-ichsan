...
public class DlgCekinMobileJKN extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(510, 300));

        jLabel29.setForeground(new java.awt.Color(0, 131, 62));
        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel29.setText("CHECKIN");
        jLabel29.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        jLabel29.setPreferredSize(new java.awt.Dimension(120, 100));
        jPanel2.add(jLabel29);

        PanelWall.setBackground(new java.awt.Color(238, 238, 255));
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/48x48/generate-qrcode-0196R011(3).png"))); // NOI18N
        PanelWall.setForeground(new java.awt.Color(238, 238, 255));
        PanelWall.setPreferredSize(new java.awt.Dimension(350, 300));
    ...
    private void NoRMPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoRMPasienKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
          ...
          //      form.tampilfingerprint(NoRMPasien.getText());
             ...
             //   form.tampilfingerprint(Sequel.cariIsi("select referensi_mobilejkn_bpjs.nomorkartu from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.norm='" + NoRMPasien.getText() + "' and referensi_mobilejkn_bpjs.status != 'Batal' and referensi_mobilejkn_bpjs.tanggalperiksa=CURRENT_DATE()"));
                form.setSize(this.getWidth(), this.getHeight());
                form.setLocationRelativeTo(jPanel1);
                this.dispose();
                form.setVisible(true);
