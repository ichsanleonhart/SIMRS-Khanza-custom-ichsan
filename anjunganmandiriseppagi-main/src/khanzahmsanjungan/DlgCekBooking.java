    ...
    private void NoRMPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoRMPasienKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (NoRMPasien.getText().equals("")) {
                ...
                NoRMPasien.setText("");
            } else if (Sequel.cariInteger("SELECT count(kd_pj) FROM booking_registrasi WHERE no_rkm_medis = '" + NoRMPasien.getText() + "' AND kd_pj='BPJ' AND tanggal_periksa=current_date()") > 0) {
                JOptionPane.showMessageDialog(rootPane, "Untuk pasien BPJS, Silahkan cekin menggunakan menu BPJS");
                NoRMPasien.setText("");
