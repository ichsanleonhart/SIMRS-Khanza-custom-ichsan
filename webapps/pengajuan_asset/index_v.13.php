...
/*
 * ==================================================================
 * INDEX.PHP (REFACTORED - V.13 / Sesi 1)
 * ==================================================================
 * Ini adalah file "View" utama.
 *
 * [UPDATE V.13 - Sesi 1]:
 * - Menambahkan "Menu 3: Riwayat Approval (Bisa Diedit)" di dashboard Logum
 */
...
<head>
    ...
    <style>
        ...
        /* [BARU V.13] Grid 3 kolom untuk Logum */
        .menu-wrapper-3col {
            display: grid;
            grid-template-columns: 1fr;
            gap: 25px;
...
<body>
    ...
    <div class="container">
        <div class="content">
                ...
                ?>
                    <div class="form-section">
                        ...
                        <p class="alert alert-danger" style="background-color: #fcf8e3; color: #8a6d3b; border-color: #faebcc;">
                            <strong>Perhatian:</strong> Fitur Edit belum diimplementasikan.
                        </p>
                         <a href="index.php" class="btn btn-secondary">Kembali ke Daftar</a>
                    </div>
            ...
            ?>
                ...
                ?>
                    <div class="form-section">
                        <h2>Proses Approval Logistik Umum</h2>
                ...
                ?>
                    <div class="form-section">
                        ...
                        <form action="index.php?action=save_direktur" method="POST" onsubmit="return handleFormSubmit(this);">
                            ...
                            <div class="action-buttons" style="margin-top: 30px;">
                                <button type="submit" class="btn btn-success" <?php echo $is_locked_by_validation ? 'disabled' : ''; ?>>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.approval-table input.format-angka').forEach(function(input) {
