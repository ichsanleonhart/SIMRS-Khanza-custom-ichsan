  ...
  $.ajax({
    ...
    success: function(data) {
        ...
        if (data.length > 0) {
            ...
            // headerRow.append("<th>No. Resep</th>");
            ...
            $.each(data, function(index, item) {
                var row = $("<tr class=''></tr>");
                row.append("<td class='col-1'>" + item.no_resep + "</td>");
                row.append("<td class='col-5'>" + item.nm_pasien + "</td>");
                row.append("<td class='col-2'>" + item.jam_peresepan + "</td>"); 
                row.append("<td class='col-2'>" + item.jam_validasi + "</td>"); 
                tbody.append(row);
            });
            ...
            // NonRacikan.append("<center>Tidak ada antrian.</center>");
        }
    },
    error: function() {
