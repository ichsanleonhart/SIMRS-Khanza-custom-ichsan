<div id="post">
    ...
    <div class="entry">        
        ...
        <table width="100%" align="center">
            ...
            <?php 
                $prosedur_non_bedah=getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(PNB)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' ) and nm_perawatan not like '%terapi%'");
                ...
                $konsultasi=(getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(KSL)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ranap Dokter' )")+
                             getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(KSL)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter')")
							);
                if($konsultasi==""){
                    $konsultasi="0";
                }
                ...
                $keperawatan=(getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(TDP)%' and no_rawat='".$norawat."' and (status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )")+
                              getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(TDP)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )")
							  );
                if($keperawatan==""){
                    $keperawatan="0";
                }
                ...
                $sewa_alat=(getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(SAA)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Harian' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )")
                           +getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(SAA)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Service' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )")
							);
                if($sewa_alat==""){
                    $sewa_alat="0";
                }				
				...
				$pelayanan_darah=getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(DRH)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )");
                if($pelayanan_darah==""){
                    $pelayanan_darah="0";
                }				
				////TAMBAHAN PENUNJANG BY ICHSAN
				$penunjang=getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(PNJ)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )");
                if($penunjang==""){
                    $penunjang="0";
                }				
				////TAMBAHAN RAWAT INTENSIF BY ICHSAN
				$rawat_intensif=getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(RIN)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )");
                if($rawat_intensif==""){
                    $rawat_intensif="0";
                }
				////TAMBAHAN BIAYA ALKES BY ICHSAN
				$alkes=getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(ALM)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )");
                if($alkes==""){
                    $alkes="0";
                }				
            ?>
           <tr class="head">
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <input name="penunjang" class="text" type="text" class="inputbox" value="<?php echo $penunjang;?>" size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <input name="pelayanan_darah" class="text" type="text" class="inputbox" value="<?php echo $pelayanan_darah;?>" size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
                <td width="41%" >Biaya Rehabilitasi</td><td width="">:</td>
                <td width="57%">
                    <input name="rehabilitasi" class="text" type="text" class="inputbox" value="<?php echo $rehabilitasi;?>"  size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <input name="rawat_intensif" class="text" type="text" class="inputbox" value="<?php echo $rawat_intensif;?>" size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <input name="alkes" class="text" type="text" class="inputbox" value="<?php echo $alkes;?>" size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
