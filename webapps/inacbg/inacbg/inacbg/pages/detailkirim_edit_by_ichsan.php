<div id="post">
    ...
    <div class="entry">        
        ...
        <table width="100%" align="center">
            ...
            <?php 
			/*ini codingan lama versi mas win ///////////////////////////////// */
                ...
                $bmhp=(getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='".$norawat."' and status='Tambahan'")+
					   ...
					   getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%(BHMP)%' and no_rawat='".$norawat."' and (status='Ralan Paramedis' or status='Ranap Paramedis' or status='Ralan Dokter Paramedis' or status='Ranap Dokter Paramedis' or status='Ralan Dokter' or status='Ranap Dokter' )")
					   );				
                if($bmhp==""){
                    $bmhp="0";
                }
            ...
            <tr class="head">
                ...
                <td width="57%">
                    <input name="pelayanan_darah" class="text" type="text" class="inputbox" value="<?php echo $bpdarah;?>" size="20" maxlength="15">
                </td>
            </tr>
            <tr class="head">
