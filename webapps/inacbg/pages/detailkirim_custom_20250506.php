        ...
        <table width="100%" align="center">
            ...
            <?php 
                ...
                $bmhp=(getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where no_rawat='".$norawat."' and status='Tambahan'")+
					   ...
					   getOne("select if(sum(totalbiaya)='','0',sum(totalbiaya)) from billing where nm_perawatan like '%BMHP%' and no_rawat='".$norawat."' and status not like '%Obat%'")  //update 24 April 2025, ngitung tindakan yang memiliki kata "Paket BMHP"
					   );				
                if($bmhp==""){
                    $bmhp="0";
                }
