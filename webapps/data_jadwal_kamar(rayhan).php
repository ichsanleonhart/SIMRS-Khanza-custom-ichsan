                      ...
                      <?php  
                          ...
                          while ($data = mysqli_fetch_array ($hasil)){
                            echo "<tr>
                                ...
                                <td align='center'><b>
                                     ";
                                     $data2=mysqli_fetch_array(bukaquery("select count(kelas) from kamar where statusdata='1' and kelas='".$data['kelas']."' and status='ISI' and kd_bangsal NOT LIKE '%ICU%' and kd_bangsal  NOT LIKE '%HCU%' and kd_bangsal  NOT LIKE '%PRN%'and kd_bangsal  NOT LIKE '%ISO%'"));
                                     echo $data2[0];
                                echo "
                                </b></td>
                                <td align='center'><b>
...
<!-- PENAMBAHAN ROW ICU-->
						<?php  
                          $_sqlA="Select kelas from kamar where statusdata='1' and kd_bangsal LIKE '%ICU%' group by statusdata" ;  
                          ...
                          while ($dataA = mysqli_fetch_array ($hasilA)){
                            echo "<tr>
                                ...
                                <td align='center'><b>
                                     ";
                                       $data3=mysqli_fetch_array(bukaquery("select count(kelas) from kamar where statusdata='1' and kelas='Kelas 2' and kd_bangsal LIKE '%ICU%'"));
                                       echo $data3[0];
                                echo "
                                </b></td>
                                <td align='center'><b>
                                     ";
                                     $data3=mysqli_fetch_array(bukaquery("select count(kelas) from kamar where statusdata='1' and kelas='Kelas 2' and status='ISI' and kd_bangsal = 'ICU'"));
                                     echo $data3[0];
                                echo "
                                </b></td>
                                <td align='center'><b>
                                      ";
                                     $data3=mysqli_fetch_array(bukaquery("select count(kelas) from kamar where statusdata='1' and kelas='Kelas 2' and status='KOSONG' and kd_bangsal LIKE '%ICU%'"));
                                     echo $data3[0];
                                echo "
                                </b></td>
                              </tr>							  
...
<!-- PENAMBAHAN ROW HCU-->
						...
						<?php  
                          $_sqlB="Select kelas from kamar where statusdata='1' and kd_bangsal LIKE '%HCU%' group by statusdata" ;  
...
<!-- PENAMBAHAN ROW PERINATOLOGI-->						
						<?php  
                          $_sqlC="Select kelas from kamar where statusdata='1' and kd_bangsal LIKE '%PRN%' group by statusdata" ;  
...
<!-- PENAMBAHAN ROW ISOLASI-->						
						<?php  
                          $_sqlD="Select kelas from kamar where statusdata='1' and kd_bangsal LIKE '%ISO%' group by statusdata" ;  
