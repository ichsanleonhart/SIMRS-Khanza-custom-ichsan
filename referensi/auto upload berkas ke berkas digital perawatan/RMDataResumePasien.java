...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Obat-obatan waktu pulang/nasihat","Kode Bayar","Cara Bayar"
        }){
...
//                }
    ...
    private void initComponents() {
        ...
        UploadResume.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        UploadResume.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        UploadResume.setName("UploadResume"); // NOI18N
        UploadResume.setPreferredSize(new java.awt.Dimension(300, 25));
        UploadResume.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UploadResumeBtnPrintActionPerformed(evt);
            }
        });
        ...
        KeluhanUtama.setPreferredSize(new java.awt.Dimension(162, 130));
        ...
        PemeriksaanFisik.setPreferredSize(new java.awt.Dimension(162, 130));
        ...
        BtnDokter2.setBounds(210, 270, 28, 23);
        ...
        BtnDokter3.setBounds(210, 330, 28, 23);
        ...
        BtnDokter5.setBounds(210, 170, 28, 23);
    ...
    private void CreatePDF(String FileName) {
      if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportPDFUpload("rptLaporanResume.jasper", "report", "::[ Upload Resume ]::", FileName, param);
        }
    }   
    ...
    */
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien.prosedur_utama,resume_pasien.kd_prosedur_utama,resume_pasien.prosedur_sekunder,resume_pasien.kd_prosedur_sekunder, "+
                    "resume_pasien.prosedur_sekunder2,resume_pasien.kd_prosedur_sekunder2,resume_pasien.prosedur_sekunder3,resume_pasien.kd_prosedur_sekunder3, "+
                    "resume_pasien.obat_pulang,reg_periksa.kd_pj,penjab.png_jawab from resume_pasien inner join reg_periksa on resume_pasien.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien.kd_dokter=dokter.kd_dokter inner join penjab on penjab.kd_pj=reg_periksa.kd_pj "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("obat_pulang"),rs.getString("kd_pj"),rs.getString("png_jawab")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            KdPj.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());     
            CaraBayar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
        }
    }
    ...
    private void isRawat() {
         ...
         if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_igd where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',ket_fisik)as keluhan from penilaian_medis_igd where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_igd where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_igd where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_igd where no_rawat=?",TNoRw.getText())); 
            ...
            PemeriksaanRad.setText(Sequel.cariIsi("select penunjang from penilaian_medis_ralan where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText())); 
         }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_anak where no_rawat='"+TNoRw.getText()+"' ")>0){ 
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',rps,'\n',rpk,'\n',rpd,'\n',rpo)as keluhan from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText())); 
            PemeriksaanFisik.setText(Sequel.cariIsi("select ket_fisik from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText()));
            PemeriksaanRad.setText(Sequel.cariIsi("select penunjang from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText()));
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_ralan_anak where no_rawat=?",TNoRw.getText()));
            ...
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_bedah where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_bedah where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_bedah where no_rawat=?",TNoRw.getText())); 
         }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_bedah_mulut where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',pemeriksaan)as keluhan from penilaian_medis_ralan_bedah_mulut where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_bedah_mulut where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_bedah_mulut where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
         }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_geriatri where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',lainnya)as keluhan from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_geriatri where no_rawat=?",TNoRw.getText()));
            ...
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_ralan_kandungan where no_rawat=?",TNoRw.getText()));    
         }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_mata where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',ket_fisik)as keluhan from penilaian_medis_ralan_mata where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_mata where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_mata where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_mata where no_rawat=?",TNoRw.getText()));    
         }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_neurologi where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',lainnya)as keluhan from penilaian_medis_ralan_neurologi where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_neurologi where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_neurologi where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_neurologi where no_rawat=?",TNoRw.getText())); 
            ...
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_orthopedi where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_orthopedi where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_orthopedi where no_rawat=?",TNoRw.getText()));  
            ...
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',lainnya)as keluhan from penilaian_medis_ralan_penyakit_dalam where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_penyakit_dalam where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_penyakit_dalam where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select terapi from penilaian_medis_ralan_penyakit_dalam where no_rawat=?",TNoRw.getText()));          
        }else if(Sequel.cariInteger("select count(no_rawat) from penilaian_medis_ralan_psikiatrik where no_rawat='"+TNoRw.getText()+"' ")>0){
            KeluhanUtama.setText(Sequel.cariIsi("select concat(keluhan_utama,'\n',ketfisik)as keluhan from penilaian_medis_ralan_psikiatrik where no_rawat=?",TNoRw.getText())); 
            PemeriksaanRad.setText(Sequel.cariIsi("select penunjang from penilaian_medis_ralan_psikiatrik where no_rawat=?",TNoRw.getText()));
            HasilLaborat.setText(Sequel.cariIsi("select penunjang from penilaian_medis_ralan_psikiatrik where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_ralan_psikiatrik where no_rawat=?",TNoRw.getText()));       
            ...
            PemeriksaanRad.setText(Sequel.cariIsi("select rad from penilaian_medis_ralan_tht where no_rawat=?",TNoRw.getText())); 
            HasilLaborat.setText(Sequel.cariIsi("select lab from penilaian_medis_ralan_tht where no_rawat=?",TNoRw.getText())); 
            ObatPulang.setText(Sequel.cariIsi("select tata from penilaian_medis_ralan_tht where no_rawat=?",TNoRw.getText()));
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien","no_rawat=?","no_rawat=?,kd_dokter=?,keluhan_utama=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,hasil_laborat=?,diagnosa_utama=?,kd_diagnosa_utama=?,"
                + "diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,"
                + "prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,"
                + "kondisi_pulang=?,obat_pulang=?,kd_pj=?,png_jawab=?",27,new String[]{
                TNoRw.getText(),KodeDokter.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),PemeriksaanRad.getText(),HasilLaborat.getText(), 
                DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(), 
                KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(), 
                ProsedurUtama.getText(),KodeProsedurUtama.getText(),ProsedurSekunder1.getText(),KodeProsedurSekunder1.getText(),ProsedurSekunder2.getText(), 
                KodeProsedurSekunder2.getText(),ProsedurSekunder3.getText(),KodeProsedurSekunder3.getText(),Kondisi.getSelectedItem().toString(),ObatPulang.getText(),
                KdPj.getText(),CaraBayar.getText(),
    ...
    private void DataSOAP() {
        try {
            ...
            try {
                ...
                pssoap.setString(2, KodeDokter.getText());
                ...
                if (!rssoap.isBeforeFirst()) { // Jika tidak ada baris hasil
                    ...
                    while (rssoap.next()) {
                        ...
                        PemeriksaanFisik.setText("Tensi:" + " " + rssoap.getString("tensi") + "," + " Nadi:" + " " + rssoap.getString("nadi") + "," + " Respirasi:" + " " + rssoap.getString("respirasi") + "," + " Suhu:" + "  " + rssoap.getString("suhu_tubuh") + "\n" + rssoap.getString("pemeriksaan"));
                        ObatPulang.setText(rssoap.getString("rtl"));
                    }
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
