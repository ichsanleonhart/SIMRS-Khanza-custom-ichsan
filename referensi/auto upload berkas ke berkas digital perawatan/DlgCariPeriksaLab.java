...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private String kamar,namakamar,datapasien="",finger="",FileName ="",kodeberkas="";
    ...
    public DlgCariPeriksaLab(java.awt.Frame parent, boolean modal) {
        ...
        tbDokter.setDefaultRenderer(Object.class, new WarnaTableHasilLab());
        ...
        tbDokter2.setDefaultRenderer(Object.class, new WarnaTableHasilLab());
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try {   
                ps4=koneksi.prepareStatement(
                    "select penjab.png_jawab,periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"+
                    ...
                    " from penjab inner join periksa_lab inner join reg_periksa inner join pasien inner join petugas  inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                    "on penjab.kd_pj=reg_periksa.kd_pj and periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_lab.nip=petugas.nip and periksa_lab.kd_dokter=dokter.kd_dokter "+
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("carabayar",rs.getString("png_jawab"));
    ...
    */
    ...
    public void setPasien(String pasien, Date tgl1, Date tgl2){
