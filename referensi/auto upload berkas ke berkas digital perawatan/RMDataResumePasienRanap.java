...
import simrskhanza.DlgCatatanAlergi;
...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private String kodekamar="",namakamar="",tglkeluar="",jamkeluar="",finger="",FileName ="",kodeberkas="";
...
//                }
    ...
    private void initComponents() {
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-11-2024 22:01:32" }));
        ...
        jLabel4.setBounds(0, 170, 220, 23);
        ...
        TPasien.setBounds(380, 10, 410, 24);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(275, 10, 95, 24);

        jLabel25.setText("Diagnosa Sekunder 2 :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(0, 760, 145, 23);
        ...
        DiagnosaSekunder2.setBounds(155, 760, 550, 24);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 790, 145, 23);
        ...
        DiagnosaUtama.setBounds(155, 700, 550, 24);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(0, 700, 145, 23);
        ...
        DiagnosaSekunder3.setBounds(155, 790, 550, 24);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 820, 145, 23);
        ...
        DiagnosaSekunder4.setBounds(155, 820, 550, 24);
        ...
        KeluhanUtama.setPreferredSize(new java.awt.Dimension(162, 150));
        ...
        scrollPane2.setBounds(230, 170, 560, 75);
        ...
        jLabel8.setText("Pemeriksaan Fisik dan Vital Sign :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 250, 220, 23);
        ...
        PemeriksaanFisik.setPreferredSize(new java.awt.Dimension(162, 150));
        ...
        scrollPane3.setBounds(230, 255, 560, 75);

        jLabel9.setText("Pemeriksaan Penunjang Rad Terpenting :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(0, 420, 220, 23);
        ...
        scrollPane4.setBounds(230, 425, 560, 55);

        jLabel10.setText("Pemeriksaan Penunjang Lab Terpenting :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(0, 490, 220, 23);
        ...
        HasilLaborat.setPreferredSize(new java.awt.Dimension(162, 100));
        ...
        scrollPane5.setBounds(230, 490, 560, 55);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(0, 677, 145, 23);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 730, 145, 23);
        ...
        DiagnosaSekunder1.setBounds(155, 730, 550, 24);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(680, 677, 90, 24);
        ...
        KodeDiagnosaUtama.setBounds(710, 700, 75, 24);
        ...
        KodeDiagnosaSekunder1.setBounds(710, 730, 75, 24);
        ...
        KodeDiagnosaSekunder2.setBounds(710, 760, 75, 24);
        ...
        KodeDiagnosaSekunder3.setBounds(710, 790, 75, 24);
        ...
        KodeDiagnosaSekunder4.setBounds(710, 820, 75, 24);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(0, 850, 145, 23);
        ...
        ProsedurUtama.setBounds(155, 850, 550, 24);
        ...
        KodeProsedurUtama.setBounds(710, 850, 75, 24);
        ...
        ProsedurSekunder1.setBounds(155, 880, 550, 24);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(0, 880, 145, 23);
        ...
        KodeProsedurSekunder1.setBounds(710, 880, 75, 24);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 910, 145, 23);
        ...
        ProsedurSekunder2.setBounds(155, 910, 550, 24);
        ...
        KodeProsedurSekunder2.setBounds(710, 910, 75, 24);
        ...
        KodeProsedurSekunder3.setBounds(710, 940, 75, 24);
        ...
        ProsedurSekunder3.setBounds(155, 940, 550, 24);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 940, 145, 23);

        label14.setText("Dokter P.J. :");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label14);
        label14.setBounds(0, 42, 120, 23);
        ...
        BtnDokter.setBounds(430, 42, 28, 23);

        jLabel37.setText("Cara Keluar :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(390, 1190, 70, 23);
        ...
        CaraKeluar.setBounds(465, 1190, 180, 24);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 1190, 100, 23);
        ...
        KodeDokterPengirim.setBounds(125, 72, 100, 24);
        ...
        NamaDokterPengirim.setBounds(230, 72, 231, 24);

        jLabel23.setText("Alasan Masuk Dirawat :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(370, 105, 120, 23);
        ...
        Alasan.setBounds(500, 105, 290, 24);

        jLabel24.setText("Diagnosa Awal Masuk :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(0, 105, 120, 23);
        ...
        DiagnosaAwal.setBounds(125, 105, 240, 24);

        jLabel12.setText("Tindakan/Operasi Selama Perawatan :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(0, 550, 220, 23);
        ...
        scrollPane7.setBounds(230, 555, 560, 45);

        jLabel38.setText("Alergi Obat :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(0, 970, 145, 24);
        ...
        Alergi.setBounds(155, 970, 630, 24);

        jLabel39.setText("Diet :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(0, 1000, 145, 23);
        ...
        KetKeluar.setBounds(655, 1190, 140, 24);

        jLabel40.setText("Hasil Lab Yang Belum Selesai (Pending) :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(-5, 1050, 230, 23);
        ...
        scrollPane8.setBounds(155, 1000, 630, 50);

        jLabel41.setText("Instruksi/Anjuran Dan Edukasi (Follow Up) :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(-5, 1110, 230, 23);
        ...
        Edukasi.setPreferredSize(new java.awt.Dimension(162, 300));
        ...
        scrollPane9.setBounds(235, 1110, 551, 70);
        ...
        KetKeadaanPulang.setBounds(250, 1190, 130, 24);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(360, 1230, 100, 23);
        ...
        DIlanjutkan.setBounds(465, 1230, 180, 24);
        ...
        scrollPane10.setBounds(235, 1055, 551, 50);

        jLabel11.setText("Jalannya Penyakit Selama Perawatan :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(0, 330, 220, 23);
        ...
        scrollPane6.setBounds(230, 340, 560, 75);

        scrollPane11.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane11.setName("scrollPane11"); // NOI18N
        scrollPane11.setPreferredSize(new java.awt.Dimension(164, 164));
        ...
        ObatPulang.setPreferredSize(new java.awt.Dimension(162, 350));
        ...
        scrollPane11.setBounds(110, 1220, 270, 70);
        ...
        ObatSelamaDiRS.setPreferredSize(new java.awt.Dimension(162, 300));
        ...
        scrollPane12.setBounds(230, 610, 560, 65);

        jLabel13.setText("Obat-obatan Selama Perawatan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 610, 220, 23);
        ...
        BtnDokter19.setBounds(70, 1240, 28, 23);
        ...
        BtnDokter17.setBounds(200, 1070, 30, 23);
        ...
        BtnDokter18.setBounds(120, 1020, 28, 23);
        ...
        BtnDiagnosa.setBounds(790, 700, 28, 23);
        ...
        BtnDokter20.setBounds(190, 630, 28, 23);
        ...
        BtnDokter16.setBounds(190, 570, 28, 23);
        ...
        BtnDokter3.setBounds(190, 510, 28, 23);
        ...
        BtnDokter2.setBounds(190, 440, 28, 23);
        ...
        BtnDokter6.setBounds(190, 350, 28, 23);
        ...
        BtnDokter5.setBounds(190, 270, 28, 23);
        ...
        BtnDokter1.setBounds(190, 190, 28, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptDataResumePasienRanap.jasper","report","::[ Data Resume Pasien ]::",
                    ...
                    "resume_pasien_ranap.kd_diagnosa_sekunder2,resume_pasien_ranap.diagnosa_sekunder3,resume_pasien_ranap.kd_diagnosa_sekunder3,resume_pasien_ranap.diagnosa_sekunder4,resume_pasien_ranap.tinggi,resume_pasien_ranap.berat,"+
    ...
    private void BtnDokter6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter6ActionPerformed
        if(TNoRw.getText().isEmpty()&&TNoRM.getText().isEmpty()){
            ...
            carijalanpenyakit.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
    ...
    private void UploadResumeBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UploadResumeBtnPrintActionPerformed
        /*
        FileName = "RESUME_" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().trim()+ "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString().replaceAll(" ", "");
        CreatePDF(FileName);
    ...
    */
    ...
    private void Otomatis(){
        Alergi.setText(Sequel.cariIsi("select catatan from catatan_pasien_alergi where no_rkm_medis=?",TNoRM.getText()));
    }
