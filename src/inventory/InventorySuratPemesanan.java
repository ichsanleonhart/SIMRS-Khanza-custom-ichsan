    ...
    */
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            // Perbaikan: Mengambil nama petugas berdasarkan NIK dari tabel pegawai
            nmptg.setText(Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?", kdptg.getText()));
            
            // Perbaikan: Mengambil nama departemen dengan join table pegawai dan departemen
            // pegawai.departemen berelasi dengan departemen.dep_id
            Departemen.setText(Sequel.cariIsi(
                "select departemen.nama from pegawai " +
                "inner join departemen on pegawai.departemen = departemen.dep_id " +
                "where pegawai.nik=?", kdptg.getText()
            ));
        }        
    }
