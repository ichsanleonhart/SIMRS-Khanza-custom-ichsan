...
// Fix: Empty JSON Body untuk Hard Delete agar diterima Server
...
if (isset($_GET['mode']) && $_GET['mode'] === 'view_log') {
    ...
    json_response("success", "OK", ["data" => $data, "pagination" => ["current_page" => $page, "total_pages" => ceil($total/$limit)]]);
}
