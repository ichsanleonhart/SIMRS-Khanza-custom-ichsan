<?php
// File: get_antrean_nonracikan_display.php
...
$query_nonracikan = "
    ...
    WHERE 
        ...
        AND ro.status = 'ralan'
        /* Filter hanya yang non-racikan */
        AND ro.no_resep NOT IN (SELECT DISTINCT no_resep FROM resep_dokter_racikan) 
    GROUP BY ro.no_resep 
	ORDER BY no_antrian desc";
    //ORDER BY ro.jam ASC"; /* 'jam' adalah jam validasi */

$hasil = bukaquery($query_nonracikan); 
