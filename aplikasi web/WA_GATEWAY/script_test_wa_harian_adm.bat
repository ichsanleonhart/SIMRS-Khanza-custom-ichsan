...
set "WA_MESSAGE=Ini adalah pengecekan status bot whatsapp harian RS Karina Medika (Nomor Adm) Pengecekan ini dilakukan pada tanggal %date% jam %time%. Jika berbeda dengan jam pengiriman, segera cek whatsapp gateway-nya!"
