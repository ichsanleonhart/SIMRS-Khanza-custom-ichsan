    ...
    <div class="accordion" id="accordionTanggal">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="heading-<?php echo $day_id; ?>">
                <button class="accordion-button fs-5 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo $day_id; ?>" aria-expanded="true" aria-controls="collapse-<?php echo $day_id; ?>">
                    Laporan Tanggal: <?php echo $tanggal->format('d-m-Y'); ?>
                </button>
            </h2>
