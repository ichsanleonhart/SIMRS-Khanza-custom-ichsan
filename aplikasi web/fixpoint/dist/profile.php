...
if (isset($_POST['update'])) {
  ...
  $jabatan_id   = mysqli_real_escape_string($conn, $_POST['jabatan']);     // Masih ID
  $unit_kerja_id= mysqli_real_escape_string($conn, $_POST['unit_kerja']);  // Masih ID
...
// Ambil semua user untuk pilihan atasan, kecuali dirinya sendiri
$daftar_atasan = mysqli_query($conn, "SELECT id, nama FROM users WHERE id != $user_id");
...
$daftar_jabatan = mysqli_query($conn, "SELECT id, nama_jabatan FROM jabatan");

// Ambil daftar unit kerja
$daftar_unit = mysqli_query($conn, "SELECT id, nama_unit FROM unit_kerja");
...
<body>
  ...
  <?php while ($j = mysqli_fetch_assoc($daftar_jabatan)): ?>
  ...
  <?php while ($u = mysqli_fetch_assoc($daftar_unit)): ?>
  ...
  <?php while ($atasan = mysqli_fetch_assoc($daftar_atasan)): ?>
