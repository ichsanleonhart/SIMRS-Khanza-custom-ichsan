...
<li class="dropdown">
  <a href="#" class="nav-link has-dropdown"><i class="fas fa-desktop"></i> <span>IT DEPARTEMEN</span></a>
  <ul class="dropdown-menu">

  <?php if (in_array('data_tiket_it_hardware.php', $allowed_files)): ?>
  <li>
    <a class="nav-link" href="data_tiket_it_hardware.php">
      <i class="fas fa-cogs"></i> <span>Data Tiket IT Hard</span>
    </a>
  </li>
<?php endif; ?>
    ...
    <?php if (in_array('data_tiket_it_software.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="data_tiket_it_software.php">
          <i class="fas fa-code"></i> <span>Data Tiket IT Soft</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('data_off_duty.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="data_off_duty.php">
          <i class="fas fa-calendar-times"></i> <span>Data Off-Duty</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('off_duty.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="off_duty.php">
          <i class="fas fa-user-slash"></i> <span>Off-Duty</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('order_tiket_it_hardware.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="order_tiket_it_hardware.php">
          <i class="fas fa-ticket-alt"></i> <span>Tiket IT Hard</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('order_tiket_it_software.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="order_tiket_it_software.php">
          <i class="fas fa-ticket-alt"></i> <span>Tiket IT Soft</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('spo_it.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="spo_it.php">
          <i class="fas fa-file-alt"></i> <span>SPO IT</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('input_spo_it.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="input_spo_it.php">
          <i class="fas fa-file-signature"></i> <span>Input SPO IT</span>
        </a>
      </li>
    <?php endif; ?>

    <?php if (in_array('berita_acara.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="berita_acara.php">
          <i class="fas fa-scroll"></i> <span>Berita Acara</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('data_barang_it.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="data_barang_it.php">
          <i class="fas fa-boxes"></i> <span>Data Barang IT</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('maintenance_rutin.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="maintenance_rutin.php">
          <i class="fas fa-sync-alt"></i> <span>Maintenance Rutin</span>
        </a>
      </li>
    <?php endif; ?>
...
<li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <?php if (in_array('sip_str.php', $allowed_files)): ?>
    <li>
      <a class="nav-link" href="sip_str.php">
        <i class="fas fa-id-card"></i> <span>SIP & STR</span>
      </a>
    </li>
    <?php endif; ?>
    ...
    <?php if (in_array('persetujuan_izin.php', $allowed_files)): ?>
    <li>
      <a class="nav-link" href="#.php">
        <i class="fas fa-user-check"></i> <span>ACC Izin Keluar</span>
      </a>
    </li>
    <?php endif; ?>
    ...
    <?php if (in_array('tele_setting.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="tele_setting.php">
          <i class="fab fa-telegram-plane"></i> <span>Telegram Settings</span>
        </a>
      </li>
    <?php endif; ?>
    ...
    <?php if (in_array('kategori_software.php', $allowed_files)): ?>
      <li>
        <a class="nav-link" href="kategori_software.php">
          <i class="fas fa-code"></i> <span>Kategori Software</span>
        </a>
      </li>
    <?php endif; ?>
