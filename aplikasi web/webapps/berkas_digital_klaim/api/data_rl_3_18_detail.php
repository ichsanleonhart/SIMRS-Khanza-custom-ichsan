 ...
 * Fungsi: Menampilkan rincian transaksi obat per grup
 */
...
if ($kode_group === 'IS_NULL') {
    // Handle data yang tidak punya master (kode kosong/null)
...
$sql = "
    ...
    LIMIT 2000 -- Limit agar browser tidak crash jika data terlalu banyak
";
...
if ($stmt) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        // Tentukan Unit Pelayanan untuk Display
