...
```
cd existing_repo
git remote add origin https://gitlab.com/arifinkhanzaproject/anjungankhanza.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/arifinkhanzaproject/anjungankhanza/-/settings/integrations)
