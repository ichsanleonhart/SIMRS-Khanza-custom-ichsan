 ...
 * @author dosen
 */
public final class BPJSCekReferensiDokterDPJP11 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public BPJSCekReferensiDokterDPJP11(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode = new DefaultTableModel(null, new String[]{"Kode Dokter", "Nama Dokter","Kode BPJS","Nama Dokter BPJS"}) {
            @Override
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSCekReferensiDokterDPJP11 dialog = new BPJSCekReferensiDokterDPJP11(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   ...
                   "from maping_dokter_dpjpvclaim inner join dokter on maping_dokter_dpjpvclaim.kd_dokter=dokter.kd_dokter ");
            try {
