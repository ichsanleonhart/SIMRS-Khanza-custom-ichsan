 ...
 * @author LENOVO
 */
public class PilihanBedaPoli extends javax.swing.JDialog {
    ...
    public PilihanBedaPoli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
"inner join maping_poli_bpjs inner join maping_dokter_dpjpvclaim ON jadwal.kd_dokter=dokter.kd_dokter and jadwal.kd_poli=poliklinik.kd_poli and maping_poli_bpjs.kd_poli_rs=poliklinik.kd_poli and maping_dokter_dpjpvclaim.kd_dokter=dokter.kd_dokter where jadwal.hari_kerja=? order by poliklinik.nm_poli asc");
                ...
                while(rs.next()){
                    ...
                    String kddokterbpjs = rs.getString("kd_dokter_bpjs");
                    String kdpolibpjs = rs.getString("kd_poli_bpjs");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihanBedaPoli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihanBedaPoli dialog = new PilihanBedaPoli(new javax.swing.JFrame(), true);
