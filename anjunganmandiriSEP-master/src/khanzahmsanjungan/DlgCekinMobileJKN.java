...
public class DlgCekinMobileJKN extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        barcode = new javax.swing.JDialog();
        ...
        label1.setText("Silahkan Scan Untuk Checkin");
        label1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        internalFrame1.add(label1, java.awt.BorderLayout.PAGE_START);

        panelisi1.setLayout(new java.awt.BorderLayout());

        buttonBig1.setForeground(new java.awt.Color(0, 131, 62));
        buttonBig1.setText("Lanjut");
        buttonBig1.setFont(new java.awt.Font("Trebuchet MS", 1, 36)); // NOI18N
        buttonBig1.setOpaque(true);
        buttonBig1.setPreferredSize(new java.awt.Dimension(150, 50));
        buttonBig1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonBig1ActionPerformed(evt);
            }
        });
        panelisi1.add(buttonBig1, java.awt.BorderLayout.CENTER);

        internalFrame1.add(panelisi1, java.awt.BorderLayout.PAGE_END);

        label2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/barcodehbk.jpg"))); // NOI18N
        internalFrame1.add(label2, java.awt.BorderLayout.CENTER);

        barcode.getContentPane().add(internalFrame1, java.awt.BorderLayout.CENTER);
        ...
        jPanel3.setFont(new java.awt.Font("Trebuchet MS", 2, 36)); // NOI18N
        ...
        jLabel30.setText("No. Kartu BPJS / No. Rekam Medis Pasien");
    ...
    private javax.swing.JDialog barcode;
    ...
    private void ProgressDialog(Dialog parent) {
        ...
        new Thread(() -> {
            ...
            try {
                ...
                if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.nomorkartu) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.nomorkartu='" + NoRMPasien.getText() + "' and referensi_mobilejkn_bpjs.status<>'Batal' and  referensi_mobilejkn_bpjs.tanggalperiksa=CURRENT_DATE()") > 0) {
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    ...
                    form.setVisible(true);
                    this.setCursor(Cursor.getDefaultCursor());
                } else if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.nomorkartu) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.norm='" + NoRMPasien.getText() + "' and referensi_mobilejkn_bpjs.status<>'Batal' and referensi_mobilejkn_bpjs.tanggalperiksa=CURRENT_DATE()") > 0) {
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    SwingUtilities.invokeLater(dialog::dispose);
                    DlgRegistrasiSEPMobileJKN form = new DlgRegistrasiSEPMobileJKN(null, true);
                    form.tampil(Sequel.cariIsi("select referensi_mobilejkn_bpjs.nomorkartu from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.norm='" + NoRMPasien.getText() + "' and referensi_mobilejkn_bpjs.status<>'Batal' and referensi_mobilejkn_bpjs.tanggalperiksa=CURRENT_DATE()"));
                    form.setSize(this.getWidth(), this.getHeight());
                    form.setLocationRelativeTo(jPanel1);
                    this.dispose();
                    form.setVisible(true);
                ...
                Thread.sleep(500); // ganti dengan proses nyata
