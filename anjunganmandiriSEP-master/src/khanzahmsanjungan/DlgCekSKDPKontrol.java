...
public class DlgCekSKDPKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PilihanKontrol = new javax.swing.JDialog();
        ...
        PilihanKontrol.setTitle("PILIH SURAT KONTROL");
        PilihanKontrol.setModalityType(java.awt.Dialog.ModalityType.APPLICATION_MODAL);
        PilihanKontrol.setResizable(false);
        PilihanKontrol.setType(java.awt.Window.Type.POPUP);
        ...
        tbObat.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        tbObat.setRowHeight(70);
        tbObat.setRowMargin(5);
        ...
        panelBiasa4.add(jScrollPane1, java.awt.BorderLayout.CENTER);

        panelBiasa1.add(panelBiasa4, java.awt.BorderLayout.CENTER);

        PilihanKontrol.getContentPane().add(panelBiasa1, java.awt.BorderLayout.CENTER);
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/header.png"))); // NOI18N
        PanelWall.setBackgroundImageType(usu.widget.constan.BackgroundConstan.BACKGROUND_IMAGE_CENTER_TOP);
        PanelWall.setForeground(new java.awt.Color(255, 255, 255));
        PanelWall.setPreferredSize(new java.awt.Dimension(500, 300));
        PanelWall.setRound(false);
        PanelWall.setLayout(new java.awt.BorderLayout());
        jPanel2.add(PanelWall, java.awt.BorderLayout.PAGE_START);
        ...
        btnK.setFont(new java.awt.Font("Trebuchet MS", 2, 36)); // NOI18N
        btnK.setForeground(new java.awt.Color(15, 81, 137));
        btnK.setText("K");
        btnK.setBorder(null);
        btnK.setOpaque(true);
        btnK.setPreferredSize(new java.awt.Dimension(44, 44));
        ...
        btnR.setFont(new java.awt.Font("Trebuchet MS", 2, 36)); // NOI18N
        btnR.setForeground(new java.awt.Color(15, 81, 137));
        btnR.setText("R");
        btnR.setBorder(null);
        btnR.setOpaque(true);
        btnR.setPreferredSize(new java.awt.Dimension(44, 44));
        ...
        btnTemplate.setFont(new java.awt.Font("Trebuchet MS", 2, 36)); // NOI18N
        btnTemplate.setForeground(new java.awt.Color(15, 81, 137));
        btnTemplate.setText("TP");
        btnTemplate.setBorder(null);
        btnTemplate.setOpaque(true);
        btnTemplate.setPreferredSize(new java.awt.Dimension(44, 44));
        btnTemplate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTemplateActionPerformed(evt);
            }
        });
        jPanel3.add(btnTemplate);
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(445, 249, 390, 390));
        ...
        jLabel28.setText("Nomor Surat Kontrol / No Rekam Medis / No BPJS");
...
//                Notifications.getInstance().show(Notifications.Type.WARNING, Notifications.Location.TOP_CENTER, "Data surat kontrol tidak ditemukan!");
    ...
    private void BtnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCetakActionPerformed
        ...
        if (NoRMPasien.getText().isBlank()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Pasien telah menggunakan Mobile JKN. Silahkan cekin menggunakan menu MobileJKN");
        }else if (Sequel.cariInteger("select count(referensi_mobilejkn_bpjs.nomorreferensi) from referensi_mobilejkn_bpjs where referensi_mobilejkn_bpjs.norm='" + NoRMPasien.getText() + "' and referensi_mobilejkn_bpjs.tanggalperiksa=current_date") > 0) {
            JOptionPane.showMessageDialog(rootPane, "Pasien telah menggunakan Mobile JKN. Silahkan cekin menggunakan menu MobileJKN");
        }else {
            ProgressDialog(this);
        }
...
//            this.dispose();
//            this.setCursor(Cursor.getDefaultCursor());
//        } else if (Sequel.cariInteger("SELECT count(bridging_surat_kontrol_bpjs.no_surat) from bridging_surat_kontrol_bpjs INNER JOIN bridging_sep INNER JOIN reg_periksa on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep and bridging_sep.no_rawat=reg_periksa.no_rawat where reg_periksa.no_rkm_medis='" + NoRMPasien.getText() + "'") > 0) {
//            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//            DlgRegistrasiSEPPertama form = new DlgRegistrasiSEPPertama(null, true);
//            //form.tampilKontrol(Sequel.cariIsi("SELECT bridging_surat_kontrol_bpjs.no_surat from bridging_surat_kontrol_bpjs INNER JOIN bridging_sep INNER JOIN reg_periksa on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep and bridging_sep.no_rawat=reg_periksa.no_rawat where reg_periksa.no_rkm_medis='" + NoRMPasien.getText() + "' ORDER by bridging_surat_kontrol_bpjs.tgl_rencana desc limit 1"));
//            form.tampilKontrol(Sequel.cariIsi("SELECT b_sk.no_surat FROM bridging_sep b_sep\n"
//                    + "INNER JOIN bridging_surat_kontrol_bpjs b_sk ON b_sep.no_sep = b_sk.no_sep\n"
//                    + "WHERE b_sep.nomr = '" + NoRMPasien.getText() + "' AND b_sk.tgl_rencana <= CURDATE() AND b_sk.tgl_rencana = ("
//                    + "        SELECT MAX(b_sk2.tgl_rencana) "
//                    + "        FROM bridging_surat_kontrol_bpjs b_sk2 "
//                    + "        WHERE b_sk2.kd_poli_bpjs = b_sk.kd_poli_bpjs "
//                    + "          AND b_sk2.no_sep = b_sk.no_sep "
//                    + "          AND b_sk2.tgl_rencana <= CURDATE()) "
//                    + "ORDER BY "
//                    + "    b_sk.tgl_rencana DESC limit 1;"));
//            form.setSize(this.getWidth(), this.getHeight());
//            form.setLocationRelativeTo(jPanel1);
//            form.setVisible(true);
//            this.dispose();
//            this.setCursor(Cursor.getDefaultCursor());
//        } else if (Sequel.cariInteger("SELECT count(bridging_surat_kontrol_bpjs.no_surat) from bridging_surat_kontrol_bpjs INNER JOIN bridging_sep INNER JOIN reg_periksa INNER JOIN pasien on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep and bridging_sep.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where pasien.no_peserta='" + NoRMPasien.getText() + "' ") > 0) {
//            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
//            DlgRegistrasiSEPPertama form = new DlgRegistrasiSEPPertama(null, true);
//            form.tampilKontrol(Sequel.cariIsi("SELECT bridging_surat_kontrol_bpjs.no_surat from bridging_surat_kontrol_bpjs INNER JOIN bridging_sep INNER JOIN reg_periksa INNER JOIN pasien on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep and bridging_sep.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis where pasien.no_peserta='" + NoRMPasien.getText() + "'"));
//            form.setSize(this.getWidth(), this.getHeight());
//            form.setLocationRelativeTo(jPanel1);
//            form.setVisible(true);
//            this.dispose();
...
//        }
    ...
    private void tbObatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbObatMouseClicked
        ...
        PilihanKontrol.dispose();
        DlgRegistrasiSEPPertama form = new DlgRegistrasiSEPPertama(null, true);
        form.tampilKontrol(nosurat);
        form.setSize(this.getWidth(), this.getHeight());
        form.setLocationRelativeTo(jPanel1);
        form.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private javax.swing.JDialog PilihanKontrol;
...
//    private void tampilSurkon(String norm){ 
...
//                    "on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep where bridging_sep.nomr=?  "+
//                    "order by bridging_surat_kontrol_bpjs.tgl_rencana Limit 3");
//                try {
//                    ps.setString(1,norm);
//                    rs=ps.executeQuery();
//                    while(rs.next()){
