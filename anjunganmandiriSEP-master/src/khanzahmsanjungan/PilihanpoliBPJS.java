 ...
 * @author LENOVO
 */
public class PilihanpoliBPJS extends javax.swing.JDialog {
    ...
    public PilihanpoliBPJS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         ...
         try {
             ...
             ps=koneksi.prepareStatement("SELECT\n"
                ...
                while(rs.next()){
                    ...
                    String poli = rs.getString("kd_poli_bpjs");
                    String kdpoli = rs.getString("nm_poli_bpjs");
                    dataList.add(new DataObject("", poli,"",kdpoli,"",""));
             }
                ...
                for (DataObject data : dataArray) {
                    ...
                    labelpoli.setText(data.getField4());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihanpoliBPJS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihanpoliBPJS dialog = new PilihanpoliBPJS(new javax.swing.JFrame(), true);
