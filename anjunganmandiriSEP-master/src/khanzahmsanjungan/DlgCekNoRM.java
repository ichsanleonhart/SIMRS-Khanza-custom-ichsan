...
//        JFrame frame = new JFrame("Contoh ProgressBar");
//        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//        frame.setSize(400, 200);
//        frame.setLayout(new FlowLayout());
//        frame.toFront();
//
//        JButton btnProses = new JButton("Mulai Proses");
//        frame.add(btnProses);
//        
//
//        btnProses.addActionListener(e -> DlgCekNoRMDialog(frame));
//
...
//    }
    ...
    public DlgCekNoRM(java.awt.Frame parent, boolean id) {
        super(parent, id);
        initComponents();
        ProggresBar.setSize(350,50);
        ProggresBar.setVisible(false);
        ProggresBar.setLocationRelativeTo(null);
...
//                proggres.setValue(proggres.getValue() + 1);
//                if (proggres.getValue() == proggres.getMaximum()) {
//                    //if (Sequel.cariInteger("select count(pasien.no_rkm_medis) from pasien where pasien.no_rkm_medis='" + display.getText() + "'") == 1) {
//
//
...
//            }
//        };
//        timerProgress = new Timer (25, listenerProgress);
    ...
    private void initComponents() {
        ...
        ProggresBar = new javax.swing.JDialog();
        panelBiasa7 = new widget.PanelBiasa();
        proggres = new javax.swing.JProgressBar();
        ...
        ProggresBar.setBackground(new java.awt.Color(255, 255, 255));

        panelBiasa7.setPreferredSize(new java.awt.Dimension(565, 50));
        panelBiasa7.setLayout(new java.awt.BorderLayout());
        panelBiasa7.add(proggres, java.awt.BorderLayout.CENTER);

        ProggresBar.getContentPane().add(panelBiasa7, java.awt.BorderLayout.CENTER);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setBackground(new java.awt.Color(255, 255, 255));
        setMinimumSize(new java.awt.Dimension(1321, 1212));
        setModal(true);
        setUndecorated(true);
        setResizable(false);
        ...
        jLabel30.setText("No. Rekam Medis / NIK KTP");
        ...
        jPanel2.add(PanelWall3, java.awt.BorderLayout.CENTER);
...
//        this.setCursor(Cursor.getDefaultCursor());
        ...
        if (!NoRMPasien.getText().equals("")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "No RM Tidak Boleh Kosong");
        }
    ...
    private javax.swing.JDialog ProggresBar;
    ...
    private javax.swing.JProgressBar proggres;
