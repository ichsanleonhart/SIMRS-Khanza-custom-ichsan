...
public class DlgRegistrasiSEPPertama extends javax.swing.JDialog {
    ...
    private HalamanUtamaDepan depan = new HalamanUtamaDepan();
    private DlgCariDokter2 doktermapping = new DlgCariDokter2(null, true);
    public PilihanpoliBPJS form = new PilihanpoliBPJS(null, true);
    ...
    private String kdkel = "", kdkec = "", kdkab = "", kdprop = "", nosisrute = "", BASENOREG = "", URUTNOREG = "", link = "", klg = "SAUDARA", statuspasien = "", pengurutan = "", tahun = "", bulan = "", posisitahun = "", awalantahun = "", awalanbulan = "",
            ...
            kabupatenpj = "", hariawal = "", requestJson, URL = "", nosep = "", user = "", prb = "", peserta = "", kodedokterreg = "", kodepolireg = "",kode_polirs="",
            status = "Baru", utc = "", jeniskunjungan = "", nomorreg = "", urlaplikasi = "", urlfinger = "",urlfrista = "", userfinger = "", passfinger = "",respon="200",ADDANTRIANAPIMOBILEJKN="no",
    ...
    private boolean statusfinger = false,fristaAktif = false,aplikasiAktif = false;
    ...
    public DlgRegistrasiSEPPertama(java.awt.Frame parent, boolean id) {
        ...
        form.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                NmPoli.setText(form.getDataPoli().getText());
                KdPoli.setText(form.getNamaPoli().getText());
        ...
        if(TNoRM.getText().isBlank() || TNoRM.getText().equals("")){
            dispose();
        }
        
        
        
        btnDiagnosaAwal4.setVisible(false);
        btnDiagnosaAwal3.setVisible(false);
    ...
    private void initComponents() {
        ...
        btnFingerPrint1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/face-detection.png"))); // NOI18N
        ...
        btnFingerPrint1.setGlassColor(new java.awt.Color(255, 255, 255));
        btnFingerPrint1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnFingerPrint1.setInheritsPopupMenu(true);
        btnFingerPrint1.setPreferredSize(new java.awt.Dimension(300, 45));
        btnFingerPrint1.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        btnFingerPrint2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/fingerprint-scanner.png"))); // NOI18N
        ...
        btnFingerPrint2.setGlassColor(new java.awt.Color(255, 255, 255));
        btnFingerPrint2.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btnFingerPrint2.setPreferredSize(new java.awt.Dimension(300, 45));
        btnFingerPrint2.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        ...
        TPasien.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        TPasien.setHighlighter(null);
        TPasien.setPreferredSize(new java.awt.Dimension(64, 40));
        jPanel2.add(TPasien);
        TPasien.setBounds(470, 140, 290, 60);

        TNoRM.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        TNoRM.setHighlighter(null);
        TNoRM.setPreferredSize(new java.awt.Dimension(64, 40));
        ...
        jPanel2.add(TNoRM);
        TNoRM.setBounds(360, 140, 110, 60);

        NoKartu.setEditable(false);
        NoKartu.setBackground(new java.awt.Color(255, 255, 153));
        NoKartu.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        NoKartu.setHighlighter(null);
        jPanel2.add(NoKartu);
        NoKartu.setBounds(880, 260, 300, 60);
        ...
        jLabel20.setBounds(810, 380, 70, 60);

        TanggalSEP.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-04-2025" }));
        TanggalSEP.setDisplayFormat("dd-MM-yyyy");
        TanggalSEP.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        ...
        TanggalSEP.setBounds(880, 380, 170, 60);
        ...
        jLabel22.setBounds(1050, 380, 80, 60);

        TanggalRujuk.setForeground(new java.awt.Color(50, 70, 50));
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-04-2025" }));
        TanggalRujuk.setDisplayFormat("dd-MM-yyyy");
        TanggalRujuk.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        ...
        TanggalRujuk.setBounds(1130, 380, 170, 60);
        ...
        jLabel23.setBounds(180, 260, 180, 60);

        NoRujukan.setEditable(false);
        NoRujukan.setBackground(new java.awt.Color(255, 255, 153));
        NoRujukan.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        ...
        NoRujukan.setBounds(360, 320, 370, 60);

        NmPoli.setEditable(false);
        NmPoli.setBackground(new java.awt.Color(255, 255, 153));
        NmPoli.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        NmPoli.setHighlighter(null);
        jPanel2.add(NmPoli);
        NmPoli.setBounds(450, 380, 280, 60);

        KdPoli.setEditable(false);
        KdPoli.setBackground(new java.awt.Color(255, 255, 153));
        KdPoli.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        KdPoli.setHighlighter(null);
        jPanel2.add(KdPoli);
        KdPoli.setBounds(360, 380, 90, 60);

        LabelPoli.setForeground(new java.awt.Color(0, 131, 62));
        LabelPoli.setText("Poli Tujuan :");
        LabelPoli.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        LabelPoli.setPreferredSize(new java.awt.Dimension(55, 23));
        jPanel2.add(LabelPoli);
        LabelPoli.setBounds(250, 380, 110, 60);
        ...
        jPanel2.add(jLabel8);
        jLabel8.setBounds(210, 140, 140, 60);

        TglLahir.setEditable(false);
        TglLahir.setBackground(new java.awt.Color(245, 250, 240));
        TglLahir.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        TglLahir.setHighlighter(null);
        jPanel2.add(TglLahir);
        TglLahir.setBounds(360, 200, 110, 60);
        ...
        jLabel18.setBounds(1080, 140, 40, 60);

        JK.setEditable(false);
        JK.setBackground(new java.awt.Color(245, 250, 240));
        JK.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        JK.setHighlighter(null);
        jPanel2.add(JK);
        JK.setBounds(1120, 140, 90, 60);
        ...
        jLabel25.setBounds(480, 200, 60, 60);

        Status.setEditable(false);
        Status.setBackground(new java.awt.Color(245, 250, 240));
        Status.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        Status.setHighlighter(null);
        jPanel2.add(Status);
        Status.setBounds(540, 200, 190, 60);
        ...
        jLabel27.setBounds(770, 320, 110, 60);
        ...
        AsalRujukan.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        ...
        AsalRujukan.setBounds(880, 320, 170, 60);

        NoTelp.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        ...
        btnDPJPLayanan.setBounds(740, 440, 40, 60);
        ...
        jLabel56.setBounds(1050, 320, 80, 60);
        ...
        jPanel2.add(NoSKDP);
        NoSKDP.setBounds(360, 260, 370, 60);
        ...
        jLabel26.setBounds(260, 320, 100, 60);

        NIK.setBackground(new java.awt.Color(255, 255, 153));
        NIK.setFont(new java.awt.Font("Poppins", 0, 16)); // NOI18N
        NIK.setHighlighter(null);
        jPanel2.add(NIK);
        NIK.setBounds(880, 200, 300, 60);
        ...
        jPanel2.add(jLabel7);
        jLabel7.setBounds(800, 260, 80, 60);
        ...
        btnDPJPLayanan1.setBounds(730, 380, 50, 60);
        ...
        btnDiagnosaAwal1.setBounds(730, 320, 50, 60);
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-04-2025" }));
        ...
        panelBiasa1.add(btnDiagnosaAwal3);
        ...
        panelBiasa1.add(btnDiagnosaAwal4);
        ...
        panelBiasa1.add(lblTerapi);
        lblTerapi.setBounds(230, 520, 340, 20);
        ...
        panelBiasa1.add(NmDokterTerapi);
        NmDokterTerapi.setBounds(310, 570, 260, 30);
        ...
        panelBiasa1.add(btnDokterTerapi);
        btnDokterTerapi.setBounds(570, 570, 40, 30);
        ...
        panelBiasa1.add(btnPoliTerapi);
        btnPoliTerapi.setBounds(570, 540, 40, 30);
        ...
        panelBiasa1.add(KdDPJPLayanan);
        KdDPJPLayanan.setBounds(230, 470, 80, 30);
        ...
        panelBiasa1.add(NmDPJPLayanan);
        NmDPJPLayanan.setBounds(310, 470, 260, 30);
        ...
        panelBiasa1.add(LabelPoli7);
        LabelPoli7.setBounds(90, 470, 140, 30);
        ...
        panelBiasa1.add(btnDiagnosaAwal2);
        ...
        panelBiasa1.add(KdPpkRujukan);
        KdPpkRujukan.setBounds(320, 280, 75, 30);

        NmPpkRujukan.setEditable(false);
        NmPpkRujukan.setBackground(new java.awt.Color(245, 250, 240));
        NmPpkRujukan.setHighlighter(null);
        panelBiasa1.add(NmPpkRujukan);
        NmPpkRujukan.setBounds(400, 280, 260, 30);
        ...
        panelBiasa1.add(btnDiagnosaAwal);
        btnDiagnosaAwal.setBounds(660, 310, 40, 30);
        ...
        jLabel13.setBounds(200, 520, 140, 30);
        ...
        panelBiasa1.add(JenisPelayanan);
        JenisPelayanan.setBounds(340, 520, 110, 30);

        LabelKelas.setForeground(new java.awt.Color(0, 131, 62));
        LabelKelas.setText("Kelas :");
        LabelKelas.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        panelBiasa1.add(LabelKelas);
        LabelKelas.setBounds(460, 520, 50, 30);
        ...
        panelBiasa1.add(Kelas);
        Kelas.setBounds(510, 520, 100, 30);
        ...
        jLabel42.setBounds(140, 10, 140, 50);
        ...
        TujuanKunjungan.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        ...
        panelBiasa1.add(TujuanKunjungan);
        TujuanKunjungan.setBounds(280, 10, 340, 50);
        ...
        panelBiasa1.add(jLabel43);
        jLabel43.setBounds(140, 70, 140, 50);
        ...
        FlagProsedur.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        FlagProsedur.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                FlagProsedurKeyPressed(evt);
            }
        });
        panelBiasa1.add(FlagProsedur);
        FlagProsedur.setBounds(280, 70, 340, 50);
        ...
        panelBiasa1.add(jLabel44);
        jLabel44.setBounds(140, 130, 140, 50);
        ...
        Penunjang.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        Penunjang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PenunjangKeyPressed(evt);
            }
        });
        panelBiasa1.add(Penunjang);
        Penunjang.setBounds(280, 130, 340, 50);
        ...
        panelBiasa1.add(jLabel45);
        jLabel45.setBounds(650, 20, 150, 50);
        ...
        AsesmenPoli.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        AsesmenPoli.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AsesmenPoliKeyPressed(evt);
            }
        });
        panelBiasa1.add(AsesmenPoli);
        AsesmenPoli.setBounds(800, 20, 340, 50);
        ...
        btnFingerPrint.setText("Verifikasi Biometrik");
        ...
        btnFingerPrint.setRoundRect(true);
        ...
        if (!NoKartu.getText().equals("")) {
            try {
                ...
                requestJson = " {"
                        ...
                        + "\"jnsPelayanan\": \"" + JenisPelayanan.getSelectedItem().toString().substring(0, 1) + "\","
                        + "\"jnsPengajuan\": \"2\","
                        + "\"keterangan\": \"Pengajuan SEP Finger oleh Anjungan Mandiri\","
                        + "\"user\": \"NoRM:" + TNoRM.getText() + "\""
                        + "}"
                        + "}"
                        + "}";
...
//        this.setCursor(Cursor.getDefaultCursor());
       ...
       Valid.MyReportqry("rptBuktiRegisterBPJS.jasper", "report", "::[ Bukti Register ]::",
                ...
                + "reg_periksa.stts_daftar,penjab.png_jawab,pasien.no_peserta,bridging_sep.no_sep \n"
                + "from reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab INNER JOIN bridging_sep \n"
                + "on reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli and reg_periksa.no_rawat=bridging_sep.no_rawat where reg_periksa.no_rawat='" + norawat + "' ", param);
        this.setCursor(Cursor.getDefaultCursor());

    }

    private void insertSEPlama() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        try {
            tglkkl = "0000-00-00";
            if (LakaLantas.getSelectedIndex() > 0) {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (Sequel.menyimpantf2("reg_periksa", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 19,
                    ...
                    Sequel.mengedit("pasien", "no_rkm_medis=?", "no_ktp=?,no_tlp=?,umur=CONCAT(CONCAT(CONCAT(TIMESTAMPDIFF(YEAR, tgl_lahir, CURDATE()), ' Th '),CONCAT(TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) div 12) * 12), ' Bl ')),CONCAT(TIMESTAMPDIFF(DAY, DATE_ADD(DATE_ADD(tgl_lahir,INTERVAL TIMESTAMPDIFF(YEAR, tgl_lahir, CURDATE()) YEAR), INTERVAL TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) div 12) * 12) MONTH), CURDATE()), ' Hr'))", 3, new String[]{NIK.getText(),NoTelp.getText(),TNoRM.getText()});
    ...
    public void tampil2(String nomorrujukan, String kdokterbpjs,String kodepoliBpjs) {
...
//                System.out.println(response);
                ...
                nmpnj.setText("BPJS");
                NoTelp.setText(Sequel.cariIsi("select pasien.no_tlp from pasien where pasien.no_rkm_medis=?", TNoRM.getText()));
                Catatan.setText("Anjungan Mandiri");
...
//                }
                ...
                emptTeks();
                JOptionPane.showMessageDialog(rootPane, "Notif : "+nameNode.path("message").asText());
    ...
    public void tampil3(String nomorrujukan, String kdokterbpjs,String kodepoliBpjs) {
...
//                KdDPJP.setText(kodedokterbpjs);
//                NmDPJP.setText(namadokterbpjs);
//                KdDPJPLayanan.setText(kodedokterbpjs);
//                NmDPJPLayanan.setText(namadokterbpjs);
...
//        }
    ...
    public void tampilPecahSEP(String nomorrujukan,String kodedokterbpjs, String kodepolibpjs,String kodepolirs,String kodedokters,String namaDOkter,String noSEP, String getTanggalKontrol,String noskdp) {
        try {
            URL = link + "/Rujukan/Peserta/" + nomorrujukan;
            headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
...
//                Kelas.setSelectedItem(response.path("peserta").path("hakKelas").path("kode").asText() + ". " + response.path("peserta").path("hakKelas").path("keterangan").asText().replaceAll("KELAS", "Kelas"));
                ...
                TglLahir.setText(response.path("peserta").path("tglLahir").asText());
                KdPoli.setText(kodepolibpjs);
                NmPoli.setText(Sequel.cariIsi("select maping_poli_bpjs.nm_poli_bpjs from maping_poli_bpjs where kd_poli_bpjs='"+KdPoli.getText()+"' "));
                KdDPJP.setText(kodedokterbpjs);
                NmDPJP.setText(Sequel.cariIsi("select maping_dokter_dpjpvclaim.nm_dokter_bpjs from maping_dokter_dpjpvclaim where maping_dokter_dpjpvclaim.kd_dokter_bpjs='"+KdDPJP.getText()+"' "));
                KdDPJPLayanan.setText(KdDPJP.getText());
                NmDPJPLayanan.setText(NmDPJP.getText());
...
//        btnFingerPrintActionPerformed(null);
    ...
    public void tampilKontrol(String noSKDP) {
        ...
        String kodepoliRS = Sequel.cariIsi("SELECT maping_poli_bpjs.kd_poli_rs from maping_poli_bpjs where maping_poli_bpjs.kd_poli_bpjs='"+KdPoliKontrol+"'");
        String dokteraktif = Sequel.cariIsi("select jadwal.kd_dokter from jadwal WHERE jadwal.kd_poli='"+kodepoliRS+"' and jadwal.hari_kerja='"+hari+"' ");
        String kodedokterRSaktif = Sequel.cariIsi("SELECT maping_dokter_dpjpvclaim.kd_dokter_bpjs from maping_dokter_dpjpvclaim where maping_dokter_dpjpvclaim.kd_dokter='"+dokteraktif+"'");

        if (!tglkontrol.equals(Sequel.cariIsi("select current_date()"))) {
             if (Sequel.cariInteger("select count(jadwal.kd_dokter) from jadwal WHERE jadwal.kd_dokter='" + kdDokterKontrol + "' and jadwal.hari_kerja=current_date() ") == 1) {
                i = JOptionPane.showConfirmDialog(null, "Surat Kontrol Tidak Sesuai, Apakah Di sesuaikan dengan hari ini ????", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                ...
                i = JOptionPane.showConfirmDialog(null, "Surat Kontrol Tidak Sesuai, Apakah Di sesuaikan dengan hari ini ????", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                if (i == JOptionPane.YES_OPTION) {
                    UpdateSuratKontrol(noSKDP, noSEP, kodedokterRSaktif, KdPoliKontrol, Sequel.cariIsi("select current_date()"), "anjungan");
                }
...
//                        JOptionPane.showMessageDialog(rootPane, "Respon BPJS : "+nameNode.path("message").asText());
            ...
            JOptionPane.showMessageDialog(rootPane, "Maaf, Tidak Bisa Ubah Surat Kontrol");
        }
...
if (NIK.getText().isBlank()) {
        ...
        try {
            ...
            if (fristaAktif) {
                ...
                Runtime.getRuntime().exec(koneksiDB.URLAPLIKASIFRISTA());
                Thread.sleep(5000);
    ...
    private void kembali(){
        HalamanUtamaDepan depan = new HalamanUtamaDepan();
        depan.setSize(this.getWidth(), this.getHeight());
        depan.setLocationRelativeTo(this);
...
// tidak bisa ditutup manual
    ...
    public void tampilRujukanNorujukan(String norujukan){
        try {
            URL = link + "/Rujukan/" + norujukan;
            headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            headers.add("X-Cons-ID", koneksiDB.CONSIDAPIBPJS());
            utc = String.valueOf(api.GetUTCdatetimeAsString());
    ...
    private void insertSEP() {
        ...
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                response = mapper.readTree(api.Decrypt(root.path("response").asText(), utc)).path("sep").path("noSep"); //edited by rsb1
                if (Sequel.menyimpantf2("reg_periksa", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 19,
                        new String[]{NoReg.getText(), TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + ""), Sequel.cariIsi("select current_time()"),
                            kodedokterreg, TNoRM.getText(), kodepolireg, TPngJwb.getText(), TAlmt.getText(), THbngn.getText(), TBiaya.getText(), "Belum",
                            statuspasien, "Ralan", Kdpnj.getText(), umur, sttsumur, "Belum Bayar", status}) == true) {

                    Sequel.mengedit("pasien", "no_rkm_medis=?", "no_tlp=?,umur=CONCAT(CONCAT(CONCAT(TIMESTAMPDIFF(YEAR, tgl_lahir, CURDATE()), ' Th '),CONCAT(TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) div 12) * 12), ' Bl ')),CONCAT(TIMESTAMPDIFF(DAY, DATE_ADD(DATE_ADD(tgl_lahir,INTERVAL TIMESTAMPDIFF(YEAR, tgl_lahir, CURDATE()) YEAR), INTERVAL TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) - ((TIMESTAMPDIFF(MONTH, tgl_lahir, CURDATE()) div 12) * 12) MONTH), CURDATE()), ' Hr'))", 2, new String[]{NoTelp.getText(), TNoRM.getText()});
                    Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(rujuk_masuk.no_rawat,4),signed)),0) from reg_periksa inner join rujuk_masuk on reg_periksa.no_rawat=rujuk_masuk.no_rawat where reg_periksa.tgl_registrasi='" + Valid.SetTgl(TanggalSEP.getSelectedItem() + "") + "' ", "BR/" + dateformat.format(TanggalSEP.getDate()) + "/", 4, NoRujukMasuk);
                    Sequel.menyimpan("rujuk_masuk", "?,?,?,?,?,?,?,?,?,?", 10, new String[]{
                        TNoRw.getText(), NmPpkRujukan.getText(), "-", NoRujukan.getText(), "0", NmPpkRujukan.getText(), KdPenyakit.getText(), "-",
                        "-", NoRujukMasuk.getText()
